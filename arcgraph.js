...
// Read dummy data
d3.json("https://raw.githubusercontent.com/manuel-widmer/swissling/master/swissling.json", function( data) {
  ...
  nodes
    .on('mouseover', function (d) {
      ...
      links
        ...
        .style('stroke-width', function (link_d) { return link_d.source === d.id || link_d.target === d.id ? 2.5 : 1;})
      labels
        .style("font-size", function(label_d){ return label_d.name === d.name ? 16 : 10 } )
        .attr("y", function(label_d){ return label_d.name === d.name ? 0 : 0 } )
